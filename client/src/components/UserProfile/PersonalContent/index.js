                            ...
                            userProfile.isWorkingRemotely ?
                                (
                                    ...
                                    <>
                                        ...
                                        <ListItemText
                                            primary="I am working remotely; work won't contribute to my chances of contracting COVID-19."/>
                                        {getEditStatus() ?
                                            (
                                                <ListItemSecondaryAction>
                                                    <Switch
                                    ...
                                    <>
                                        ...
                                        <ListItemText
                                            primary="I am not working remotely; work could contribute to my chances of contracting COVID-19."/>
                                        {getEditStatus() ?
                                            (
                                                <ListItemSecondaryAction>
                                                    <Switch
